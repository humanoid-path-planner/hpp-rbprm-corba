...
#~ fullBody.addLimb(rKneeId, rLeg,rKnee,rLegOffset,rLegNormal, rLegx, rLegy, 5000, 0.01)
...
#~ fullBody.addLimb(lKneeId,lLeg,lKnee,lLegOffset,lLegNormal, lLegx, lLegy, 5000, 0.01)
#~  	
...
q_init [0:3] = [0, -0.5, 0.6]; fullBody.setCurrentConfig (q_init); r (q_init)
