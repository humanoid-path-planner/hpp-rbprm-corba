...
class Player(object):
    def __init__(
        ...
        self.limbsCOMConstraints = {
            self.rLegId: {
                "file": "hyq/" + self.rLegId + "_com.ineq",
                "effector": self.rfoot,
            },
            self.lLegId: {
                "file": "hyq/" + self.lLegId + "_com.ineq",
                "effector": self.lfoot,
            },
            self.rarmId: {
                "file": "hyq/" + self.rarmId + "_com.ineq",
                "effector": self.rHand,
            },
            self.larmId: {
                "file": "hyq/" + self.larmId + "_com.ineq",
                "effector": self.lHand,
            },
        }
    ...
    def initConfig(self):
        ...
        if len(self.configs) > 1:
            ...
            q_init[0:7] = self.tp.ps.configAtParam(0, 0.01)[
                0:7
    ...
    def endConfig(self):
        ...
        if len(self.configs) > 1:
            ...
            q_goal[0:7] = self.tp.ps.configAtParam(0, self.tp.ps.pathLength(0))[
                0:7
            ]  # use this to get the correct orientation
    ...
    def play(self, frame_rate=1.0 / 60.0):
