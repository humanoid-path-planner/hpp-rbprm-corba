...
rLegy = 0.05
fullBody.addLimb(
    rLegId, rLeg, "", rLegOffset, rLegNormal, rLegx, rLegy, 50000, "manipulability", 0.1
)
...
lLegy = 0.05
fullBody.addLimb(
    lLegId, lLeg, "", lLegOffset, rLegNormal, lLegx, lLegy, 50000, "manipulability", 0.1
)
...
acc_goal = tp.ps.configAtParam(pId, tp.ps.pathLength(pId) - 0.01)[
...
configs = fullBody.interpolate(
    0.001, pathId=pId, robustnessTreshold=3, filterStates=True
)
