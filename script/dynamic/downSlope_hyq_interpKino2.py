...
dir_goal = tp.ps.configAtParam(pathId, tp.ps.pathLength(pathId) - 0.01)[7:10]
acc_goal = tp.ps.configAtParam(pathId, tp.ps.pathLength(pathId) - 0.01)[10:13]
configSize = (
...
configs = fullBody.interpolate(
    0.08, pathId=pathId, robustnessTreshold=0, filterStates=True
)
