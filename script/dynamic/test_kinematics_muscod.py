...
res1Bis = get_com_constraint(
    fullBody, state1, config1, limbsCOMConstraints, interm=True
)
res2Bis = get_com_constraint(
    fullBody, state2, config2, limbsCOMConstraints, interm=True
)
