...
nodes = ["hyq"]
r.client.gui.setCaptureTransform(
    "/local/dev_hpp/screenBlender/iros2018/yaml/hyq_side_poly.yaml", nodes
)
r(q_init)
...
r.client.gui.setCaptureTransform(
    "/local/dev_hpp/screenBlender/iros2017/yaml/detour_path_GEOM_ctc.yaml", nodes
)
r(q_init)
r.client.gui.captureTransformOnRefresh(True)
pp.speed = 1
...
r.client.gui.setCaptureTransform(
    "/local/dev_hpp/screenBlender/iros2017/yaml/slope_ctc_path.yaml", nodes
)
r(q_init)
r.client.gui.captureTransformOnRefresh(True)
pp.speed = 0.5
...
nodes = ["hrp2_14"]
r.client.gui.setCaptureTransform(
    "/local/dev_hpp/screenBlender/tro/yaml/darpa/success_cs.yaml", nodes
)
r(q_init)
...
r.client.gui.setCaptureTransform(
    "/local/dev_hpp/screenBlender/tro/yaml/darpa/motion2.yaml", nodes
)
...
nodes = ["talos"]
r.client.gui.setCaptureTransform(
    "/local/dev_hpp/screenBlender/talos/yaml/airbus_stairs.yaml", nodes
)
# r.client.gui.captureTransform()
r(configsFull[0])
r.client.gui.captureTransformOnRefresh(True)
...
r.client.gui.writeBlenderScript(
    "/local/dev_hpp/screenBlender/talos/models/pyrene.py", ["talos"]
)

r.client.gui.writeBlenderScript(
    "/local/dev_hpp/screenBlender/talos/stairs.py", ["world"]
)

nodes = ["hrp2_14", "Vec_Acceleration", "Vec_Velocity"]
r.client.gui.setCaptureTransform(
    "/local/dev_hpp/screenBlender/iros2017/yaml/slope_interp_3.yaml", nodes
)
r.client.gui.captureTransformOnRefresh(True)
player.play(1 / 10.0)
r.client.gui.captureTransformOnRefresh(False)
...
r.client.gui.writeNodeFile(
    "path_0_root",
    "/local/dev_hpp/screenBlender/iros2017/meshs/path_detour_geom_CTC.obj",
)
