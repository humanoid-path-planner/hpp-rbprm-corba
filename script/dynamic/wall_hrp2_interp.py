...
fullBody.addLimb(
    rLegId, rLeg, "", rLegOffset, rLegNormal, rLegx, rLegy, 20000, "dynamic", 0.1
)
...
fullBody.addLimb(
    lLegId, lLeg, "", lLegOffset, rLegNormal, lLegx, lLegy, 20000, "dynamic", 0.1
)
...
q_init[0:7] = tp.ps.configAtParam(0, 0.0001)[
    0:7
