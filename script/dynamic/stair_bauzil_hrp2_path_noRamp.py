...
rbprmBuilder.setJointBounds("base_joint_xyz", [0, 1.55, -0.25, -0.15, 0.50, 1.3])
...
ps.client.problem.setParameter("aMaxZ", omniORB.any.to_any(2.0))
...
r = Viewer(ps, displayArrows=True, displayCoM=True)
...
afftool.loadObstacleModel(
    packageName, "stair_bauzil", "planning", r, reduceSizes=[0.1, 0]
)
