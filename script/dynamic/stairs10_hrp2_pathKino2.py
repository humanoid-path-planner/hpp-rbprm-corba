...
rbprmBuilder.setJointBounds("base_joint_xyz", [0, 1, 0.6, 1.1, 0.45, 1.5])
...
ps.client.problem.setParameter("orientedPath", omniORB.any.to_any(0.0))
...
afftool.loadObstacleModel(
    packageName, ENV_NAME, ENV_PREFIX, r, reduceSizes=[0.17, 0, 0]
)
