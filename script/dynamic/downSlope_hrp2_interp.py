...
fullBody.addLimb(
    rLegId, rLeg, "", rLegOffset, rLegNormal, rLegx, rLegy, 50000, "dynamic", 0.1
)
...
fullBody.addLimb(
    lLegId, lLeg, "", lLegOffset, rLegNormal, lLegx, lLegy, 50000, "dynamic", 0.1
)
...
configs = fullBody.interpolate(
    0.05, pathId=pId, robustnessTreshold=1, filterStates=True
)
