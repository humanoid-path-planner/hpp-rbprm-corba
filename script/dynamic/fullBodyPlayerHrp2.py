...
class Player(object):
    def __init__(
        ...
        self.limbsCOMConstraints = {
            self.rLegId: {"file": "hrp2/RL_com.ineq", "effector": "RLEG_JOINT5"},
    ...
    def initConfig(self):
        ...
        if len(self.configs) > 1:
            ...
            q_init[0:7] = self.tp.ps.configAtParam(self.pathId, 0.001)[
                0:7
    ...
    def endConfig(self):
        ...
        if len(self.configs) > 1:
            ...
            q_goal[0:7] = self.tp.ps.configAtParam(
                self.pathId, self.tp.ps.pathLength(self.pathId)
            )[
                0:7
            ]  # use this to get the correct orientation
    ...
    def displayContactPlan(self, timeScale=1.0):
        self.viewer.client.gui.setVisibility("hrp2_14", "ON")
        self.tp.r.client.gui.setVisibility("toto", "OFF")
        self.tp.r.client.gui.setVisibility("hrp2_trunk_flexible", "OFF")
    ...
    def interpolate(self, begin=1, end=0):
        ...
        for i in range(begin, end):
            ...
            self.act(
                ...
                optim_effectors=self.optim_effector,
                draw=self.draw,
            )

    def play(self, frame_rate=1.0 / 30.0):
