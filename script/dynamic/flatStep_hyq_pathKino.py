...
rbprmBuilder.setJointBounds ("base_joint_xyz", [-2.5,2.5, -0.5, 0.5, 0.4, 1.2])
...
afftool.loadObstacleModel (packageName, "flat_step", "planning", r)
...
q_init [0:3] = [-2.5, 0, 0.7]; rbprmBuilder.setCurrentConfig (q_init); r (q_init)
q_goal = q_init [::]
q_goal [0:3] = [2.5, 0, 0.7]
