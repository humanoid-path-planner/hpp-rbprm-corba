...
rbprmBuilder.setAffordanceFilter("SpidermanLFootSphere", affordanceTypeHand)
rbprmBuilder.setAffordanceFilter("SpidermanRFootSphere", affordanceTypeHand)
...
q_goal[0:3] = [-0.05, -0.82, 4.4]
rbprmBuilder.setCurrentConfig(q_goal)
r(q_goal)
...
afftool.loadObstacleModel(packageName, "wall", "planning", r)
# ~ afftool.analyseAll()
