...
root_bounds = [-1.5, 2.0, -0.01, 0.01, 0.4, 1.0]
...
rbprmBuilder.client.robot.setExtraConfigSpaceBounds(
    [-vMax, vMax, -vMax, vMax, -vMax, vMax, -aMax, aMax, -aMax, aMax, -aMaxZ, aMaxZ]
)
indexECS = (
...
afftool.loadObstacleModel(
    "hpp_environments", "multicontact/darpa", "planning", vf, reduceSizes=[0.08, 0, 0]
)
