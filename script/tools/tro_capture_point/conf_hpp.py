...
JOINT_POS_PREVIEW = 1.5
# preview window to convert joint pos limits into joint acc limits
JOINT_VEL_PREVIEW = 1
# preview window to convert joint vel limits into joint acc limits
MAX_JOINT_ACC = 30.0
...
w_com = 1
w_posture = 1e-3
# 1e-5;  # weight of postural task

# QP SOLVER PARAMETERS
maxIter = 300
# max number of iterations
maxTime = 0.8
# max computation time for the solver in seconds
verb = 0
...
DT_VIEWER = 10 * dt
# timestep used to display motion with viewer
