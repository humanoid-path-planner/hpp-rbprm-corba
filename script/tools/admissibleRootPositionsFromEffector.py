...
rLegy = 0.05
fullBody.addLimb(
    rLegId, rLeg, rfoot, rLegOffset, rLegNormal, rLegx, rLegy, nbSamples, 0.01
)
...
lLegy = 0.05
fullBody.addLimb(
    lLegId, lLeg, lfoot, lLegOffset, rLegNormal, lLegx, lLegy, nbSamples, 0.01
)
...
rArmy = 0.024
fullBody.addLimb(
    rarmId, rarm, rHand, rArmOffset, rArmNormal, rArmx, rArmy, nbSamples, 0.01
)
...
lArmy = 0.024
fullBody.addLimb(
    larmId, larm, lHand, lArmOffset, lArmNormal, lArmx, lArmy, nbSamples, 0.01
)
