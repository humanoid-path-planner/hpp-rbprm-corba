...
run = 0.0
f = open(
    "/local/fernbac/bench_iros18/kin_constraint_tog/without_kin_constraints.log", "r"
)
...
print(
    "percentage of feasible transition : "
...
print(
    "percentage of feasible trajectory : "
    + str(float(valid_length / traj_length) * 100.0)
    + " %"
)
