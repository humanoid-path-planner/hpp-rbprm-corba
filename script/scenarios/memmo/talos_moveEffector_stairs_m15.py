...
fullBody.setJointBounds ("root_joint", [-0.3,0.3, -0.3, 0.3, 0.75, 1.05])
...
fullBody.addLimb(fullBody.lLegId,fullBody.lleg,fullBody.lfoot,fullBody.lLegOffset,fullBody.rLegNormal, fullBody.lLegx, fullBody.lLegy, nbSamples, "static", 0.01,kinematicConstraintsPath=fullBody.lLegKinematicConstraints,kinematicConstraintsMin = 0.75)
...
zInterval = [-0.15, 0.]
zMoving = [0.,-0.15]
s0,s1 = sampleRandomTransitionStairs(fullBody,limbsInContact,zInterval,movingLimb,zMoving)
