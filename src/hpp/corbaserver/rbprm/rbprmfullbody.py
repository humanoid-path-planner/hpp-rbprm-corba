...
class FullBody (object):
    ...
    def addLimb(self, name, effectorname, offset, normal, x, y, samples, resolution):
		self.client.rbprm.rbprm.addLimb(name, effectorname, offset, normal, x, y, samples, resolution)
