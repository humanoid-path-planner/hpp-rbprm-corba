...
# reduce bounds on joints along x, to put conservative condition on the contact
# generation for sideway steps.
...
zInterval = [-0.15, 0.0]
zMoving = [0.0, -0.15]
s0, s1 = sampleRandomTransitionStairs(
    fullBody, limbsInContact, zInterval, movingLimb, zMoving
)
