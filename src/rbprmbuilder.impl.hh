  ...
  namespace rbprm {
    ...
    struct BindShooter
    {
      ...
      class RbprmBuilder : public virtual POA_hpp::corbaserver::rbprm::RbprmBuilder
      {
        ...
        virtual hpp::floatSeqSeq * getReachableContactArea (const char* limbname) throw (hpp::Error);
        // virtual void getReachableContactArea (const char* limbname) throw (hpp::Error);
